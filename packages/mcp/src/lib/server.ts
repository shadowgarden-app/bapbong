...
export function createMcpServer(
  ...
  server.registerTool(
    ...
    async ({ documentId: id }) =>
      withSession(id, async (s) => json(await s.snapshot())),
  );
    ...
    'find_text',
    {
      ...
      inputSchema: {
        ...
        query: z
          .string()
          .min(1)
          .describe('Exact text to find (case-sensitive).'),
      },
    },
    async ({ documentId: id, query }) =>
      withSession(id, async (s) => json({ matches: await s.find(query) })),
  );
  ...
  server.registerTool(
    'replace_text',
    {
      ...
      inputSchema: {
        ...
        new_text: z
          .string()
          .describe('Replacement text (empty string deletes).'),
        occurrence,
        expectedVersion,
      },
    },
    ...
    'update_image',
    {
      ...
      inputSchema: {
        ...
        block_index: z
          ...
          .min(0)
          .describe(
            'Index of the block holding the image (from get_document).',
          ),
        image_index: z
          .number()
          .int()
        ...
        width: z
          ...
          .positive()
          .optional()
          .describe('New width in CSS px.'),
        height: z
          .number()
          .positive()
          .optional()
          .describe('New height in CSS px.'),
        rotation: z
          .number()
          .optional()
